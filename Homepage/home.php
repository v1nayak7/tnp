        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="http://www.iiitu.ac.in/">Indian Institute of Information Technology, UNA</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					...
					<h3>GET IN TOUCH</h3>
					<p>Transit Campus-I: National Institute of Technology</p>
					<p>Hamirpur, Himachal Pradesh 177005</p>
					<p> 01972-224373, 01975-257902</p>
					<a href="mailto:dexcro707@gmail.com">dexcro707@gmail.com</a>
				</div>
